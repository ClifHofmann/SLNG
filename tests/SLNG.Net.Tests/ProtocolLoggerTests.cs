...
public class ProtocolLoggerTests
{
    ...
    public void ProtocolLogger_FormatsObjectUpdatesCorrectly()
    {
        ...
        var objEvent = new ObjectUpdateEvent(123ul, 42, new Vector3(1, 2, 3), Quaternion.Identity, new Vector3(1, 1, 1), 1, false, Guid.Empty, Guid.Empty, Guid.Empty, Vector4.One, 0, 0);
